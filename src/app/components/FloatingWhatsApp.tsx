...
export function FloatingWhatsApp() {
  ...
  const handleClick = () => {
    ...
    addBooking({ destination: "General Inquiry", tag: "Floating WA Button", price: "-", source: "floating" });
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-[150] w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center cursor-pointer border-none shadow-lg shadow-[#25D366]/30"
